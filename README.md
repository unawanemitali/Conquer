...
Coming from a **Mechanical Engineering** background, the traditional barrier to creating robust software used to feel incredibly high. 
...
Since this is my first app built via AI "vibe coding," there may be some bugs, loopholes, or unoptimized logic. Contributions, issues, and feature requests are highly welcome!

*   **Find a bug?** Open an Issue and describe the loophole.
*   **Want to fix it?** Fork the project, make your code changes, and submit a Pull Request. Let's build this together!

---

## 🛠️ How to Run Locally

If you want to test the app yourself, you can run it using Android Studio.
