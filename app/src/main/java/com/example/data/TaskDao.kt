...
interface TaskDao {
    ...
    @Query("UPDATE tasks SET isCompleted = :isCompleted, streak = :streak, lastCompletedAt = :lastCompletedAt WHERE id = :id")
    suspend fun updateTaskCompletionState(id: Int, isCompleted: Boolean, streak: Int, lastCompletedAt: Long)
